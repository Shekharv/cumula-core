...
class Devel extends BaseComponent {
	...
	public function __construct() {
		...
		$this->addEventListenerTo('Application', 'BootInit', 'startAppTimer');
		$this->_logEventStack = '';
	...
	public function startAppTimer($event, $dispatcher, $request, $response) {
		$this->addEventListenerTo('Cumula\\Application', 'InstanceAccessed', 'logInstanceAccessed');
		$this->addEventListenerTo('Application', 'EventDispatcherEventDispatched', 'logEventDispatch');
		$this->addEventListenerTo('Response', 'EventDispatcherEventDispatched', 'logEventDispatch');
		
		$this->addBenchmark('app_boot');
		$this->addEventListenerTo('Response', 'ResponsePrepare', 'stopAppTimer');
	}
	...
	public function startup() 
	{
		...
		foreach($components as $component) 
		{
			...
			{
				$this->addEventListenerTo($component, 'EventDispatcherEventDispatched', 'logEventDispatch');
				$this->addEventListenerTo($component, 'EventListenerRegistered', 'registerPreAndPost');
			}
		}
		
		$that = &$this;
		$this->addEventListenerTo('Cumula\\Application', 'AfterBootPreprocess', function() use (&$that) {
			$that->_afterStartup = true;
		}); 
		
		$this->addEventListenerTo('Cumula\\ComponentManager', 'EventDispatcherEventDispatched', 'logEventDispatch'); 
		$this->addEventListenerTo('Cumula\\Application', 'EventDispatcherEventDispatched', 'logEventDispatch'); 
		$this->addEventListenerTo('Cumula\\SystemConfig', 'EventDispatcherEventDispatched', 'logEventDispatch');
		$this->addEventListenerTo('Cumula\\Router', 'EventDispatcherEventDispatched', 'logEventDispatch');
	}
